...
RDEPENDS:${PN} = "\
    ...
    ${@bb.utils.contains("MACHINEBUILD", "osninoplus", "enigma2-plugin-drivers-network-usb-rt8723bs enigma2-plugin-drivers-network-usb-rt8723ds", "", d)} \
    ${@bb.utils.contains("MACHINEBUILD", "osninopro", "enigma2-plugin-drivers-network-usb-rt8723bs enigma2-plugin-drivers-network-usb-rt8723ds", "", d)} \
    ...
    ${@bb.utils.contains("MACHINEBUILD", "sf8008", "enigma2-plugin-drivers-network-usb-rtl8821cu enigma2-plugin-drivers-network-usb-rtl8192eu enigma2-plugin-drivers-network-usb-mt7601u enigma2-plugin-drivers-network-usb-rtl8822cu enigma2-plugin-drivers-network-usb-rtl8188fu", "", d)} \
    ${@bb.utils.contains("MACHINEBUILD", "sf8008m", "enigma2-plugin-drivers-network-usb-rtl8821cu enigma2-plugin-drivers-network-usb-rtl8192eu enigma2-plugin-drivers-network-usb-mt7601u enigma2-plugin-drivers-network-usb-rtl8822cu enigma2-plugin-drivers-network-usb-rtl8188fu", "", d)} \
    ...
    ${@bb.utils.contains_any("MACHINEBUILD", "vuduo4k vuduo4kse vusolo4k vuultimo4k vuuno4k vuuno4kse vuzero4k", "enigma2-plugin-drivers-network-usb-rtl8821cu enigma2-plugin-drivers-network-usb-rtl8192eu enigma2-plugin-drivers-network-usb-mt7601u enigma2-plugin-drivers-network-usb-rtl8822cu", "", d)} \
    "
